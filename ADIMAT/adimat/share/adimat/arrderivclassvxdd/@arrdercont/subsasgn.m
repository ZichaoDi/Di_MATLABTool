  ...
  switch ind(1).type
   case '()'
    ...
    elseif length(subs) == 2
      ...
      dds = reshape(obj.m_derivs, [obj.m_size obj.m_ndd]);

      if maxInd1 > sz(1) || maxInd2 > prod(sz(2:end))
        % enlarging
        trial = reshape(obj.m_derivs(:, 1), sz);
        trial(ind1, ind2) = rhsd(:, :, 1);
...
% $Id: subsasgn.m 4675 2014-09-15 11:57:39Z willkomm $
