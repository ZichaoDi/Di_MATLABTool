...
function [a_A nr_R] = a_padeExpm(A, a_R)
   ...
   if tmpba1 == 1
      ...
      [tmpirs1 tmpdummy tmpir1] = adimat_pop;
   end
end
...
function R = rec_padeExpm(A)
   ...
   adimat_push(tmpfra1_2, tmpir1, tmpdummy, tmpirs1, m, U, V, s, A2, A4, A6, W1, W2, Z1, Z2, W, l, b, n1A, lesserM, tmpda1, tmpca3, tmpca2, tmpca1, tmpda6, tmpda5, tmpca4, R, A);
end

function a_A = ret_padeExpm(a_R)
   global adimat_expm_fast;
   [A R tmpca4 tmpda5 tmpda6 tmpca1 tmpca2 tmpca3 tmpda1 lesserM n1A b l W Z2 Z1 W2 W1 A6 A4 A2 s V U m tmpirs1 tmpdummy tmpir1] = adimat_pop;
   [a_U a_V a_A2 a_A4 a_A6 a_W1 a_W2 a_Z1 a_Z2 a_W a_tmpca3 a_tmpca2 a_tmpca1 a_tmpca4 a_A] = a_zeros(U, V, A2, A4, A6, W1, W2, Z1, Z2, W, tmpca3, tmpca2, tmpca1, tmpca4, A);
   if nargin < 1
      a_R = a_zeros(R);
   end
