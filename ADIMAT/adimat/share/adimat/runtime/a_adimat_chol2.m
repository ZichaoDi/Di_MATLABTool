...
% 2) Re-vectorized, second parameter added by Johannes Willkomm, 06/17/12
   ...
   for i=1 : tmpfra1_2
      ...
      adimat_push_index(A, i, tmpda1 : n);
...
function U = rec_adimat_chol(A)
   ...
   adimat_push(tmpfra1_2);
   U = triu(A);
   adimat_push(k, n, tmplia1, tmpda2, tmpda1, tmpca1, U, A);
end

function a_A = ret_adimat_chol(a_U)
   [A U tmpca1 tmpda1 tmpda2 tmplia1 n k] = adimat_pop;
   [a_tmplia1 a_tmpca1 a_A] = a_zeros(tmplia1, tmpca1, A);
   if nargin < 1
      a_U = a_zeros(U);
   end
