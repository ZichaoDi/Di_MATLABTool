...
function [g_Pk, Pk, g_u, u]= g_mk_householder_elim_vec_lapack(g_a, a, n)
   ...
   if ~(k== 1&& isreal(a))&& sum(abs(a))~= 0
      ...
      if na> tolZ
         ...
         g_tmp_a_00000= g_a(1);
         tmp_a_00000= a(1);
         g_tmp_mk_householder_elim_vec_lapack_00000= g_tmp_a_00000+ g_nu;
         tmp_mk_householder_elim_vec_lapack_00000= tmp_a_00000+ nu;
         g_tmp_mk_householder_elim_vec_lapack_00004= (g_u.* tmp_mk_householder_elim_vec_lapack_00000- u.* g_tmp_mk_householder_elim_vec_lapack_00000)./ tmp_mk_householder_elim_vec_lapack_00000.^ 2;
         tmp_mk_householder_elim_vec_lapack_00004= u./ tmp_mk_householder_elim_vec_lapack_00000; 
         
         % Update detected: u= some_expression(u,...)
         g_u= g_tmp_mk_householder_elim_vec_lapack_00004;
         u= tmp_mk_householder_elim_vec_lapack_00004;
         g_tmp_a_00001= g_a(1);
         tmp_a_00001= a(1);
         g_tmp_mk_householder_elim_vec_lapack_00001= g_tmp_a_00001+ g_nu;
         tmp_mk_householder_elim_vec_lapack_00001= tmp_a_00001+ nu;
         g_sigma= (g_tmp_mk_householder_elim_vec_lapack_00001.* nu- tmp_mk_householder_elim_vec_lapack_00001.* g_nu)./ nu.^ 2;
         sigma= tmp_mk_householder_elim_vec_lapack_00001./ nu; 
         
         g_tmp_mk_householder_elim_vec_lapack_00002= g_sigma.* u+ sigma.* g_u;
         tmp_mk_householder_elim_vec_lapack_00002= sigma.* u;
         g_tmp_mk_householder_elim_vec_lapack_00003= g_tmp_mk_householder_elim_vec_lapack_00002* u' + tmp_mk_householder_elim_vec_lapack_00002* g_u' ;
         tmp_mk_householder_elim_vec_lapack_00003= tmp_mk_householder_elim_vec_lapack_00002* u' ;
         g_Pksub= -g_tmp_mk_householder_elim_vec_lapack_00003+ g_zeros(size(eye(k)));
         Pksub= eye(k)- tmp_mk_householder_elim_vec_lapack_00003; 
