function [X info] = pblockkaczmarz(A,b,s,K,x0,options)
%PBLOCKKACZMARZ  Block Kaczmarz algorithm with direct projction methods
%
%   [X info] = randpblockkaczmarz(A,b,s,K)
%   [X info] = randpblockkaczmarz(A,b,s,K,x0)
%   [X info] = randpblockkaczmarz(A,b,s,K,x0,options)
%
% *One iteration consists of m/s such steps. Circle update rule.*
%
% Input:
%   A          m times n matrix.
%   b          m times 1 vector.
