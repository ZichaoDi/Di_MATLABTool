...
switch lower(compoundName)
    ...
    case 'breast_hammerstein'
        
        % ratios
        comp.ratio.h = (0.112+0.098)/2;
        comp.ratio.c = (0.619+0.184)/2;
        comp.ratio.n = (0.017+0.038)/2;
        comp.ratio.o = (0.251+0.675)/2;
        comp.ratio.p = (0.001+0.005)/2;
        
        comp.density = (0.928+1.047)/2; % [g/cm^3]
