 ...
 * matter much.)
 * 3- for the release version (inside the tag-branch) create a VERSION
 * file in the root of diptree only containing the version number
 */
#define DIP_VERSION_NUMBER 2.9
